      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ paddingVertical: 10, backgroundColor: 'white' }}>
            {[...Array(5)].map((_, index) => (
              <View alignItems="center" marginHorizontal={10} key={index}>
                ...
                <Text fontSize={12}>Joko Wee</Text>
              </View>
            ))}
          </ScrollView>
          ...
          <View padding={10} backgroundColor="white" borderBottomWidth={1} borderColor="#ccc">
            <Image source={{ uri: 'https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcQmiPKNTqVfNS6rVI-8bmisVmKmlWD_iWYEGRhwGHdIdtYX9JN9m0n62TBZtSRcAa6Tnamb98e3F2OBRXU' }} style={{ width: '100%', height: 200 }} />
          ...
          {/* Post 2 */}
          <View padding={10} backgroundColor="white" borderBottomWidth={1} borderColor="#ccc">
            <Image source={{ uri: 'https://images.immediate.co.uk/production/volatile/sites/3/2023/04/naruto-762b09d.jpg?quality=90&webp=true&resize=1000,667' }} style={{ width: '100%', height: 200 }} />
